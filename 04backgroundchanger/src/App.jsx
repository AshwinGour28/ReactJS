      ...
      <div className='w-full h-screen' style={{backgroundColor: color}}>
        <div className='fixed flex flex-wrap justify-center bottom-13 inset-x-0 px-2'>
          <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl'>
            ...
            <button className='outline-none px-4 py-1 rounded-full text-white shadow-lg cursor-pointer' style={{backgroundColor: "olive"}} onClick={()=>setColor("olive")}> 
              Olive
            </button>
            ...
            <button className='outline-none px-4 py-1 rounded-full text-black shadow-lg cursor-pointer' style={{backgroundColor: "pink"}} onClick={()=>setColor("pink")}> 
              Pink
            </button>
            ...
            <button className='outline-none px-4 py-1 rounded-full text-black shadow-lg cursor-pointer' style={{backgroundColor: "lavender"}} onClick={()=>setColor("lavender")}> 
              Lavender
            </button>
